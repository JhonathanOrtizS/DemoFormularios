...
<head>
	...
	<title>EVA-180 | CMS</title>

	<meta name="viewport" content="width=device-width, initial-scale=1">

	<link rel="icon" href="{{url('/')}}/{{$blog[1]["logo"]}}">
	...
	{{-- Estilos Adicionales --}}
	<link rel="stylesheet" href="{{url('/')}}/css/style-add.css">
	...
	{{-- Fontawesome --}}
	<script src="https://kit.fontawesome.com/7d3cfb8529.js" crossorigin="anonymous"></script>
	...
	<script src="{{ url('/') }}/js/plugins/typeahead.js"></script>
...
@if (Route::has('login'))
	...
	<body class="hold-transition sidebar-mini layout-fixed">
		...
		<script src="{{url('/')}}/js/evaluaciones.js"></script>
